...
export class ApplicationContextService {
  ...
  getContextId(): string {
    ...
    switch(host){
      case "ea50a54d4ddb9ec64af3a99b283cef59" : return "insuro"  //localhost:4200
      case "4faa5c4009eae53e960ec1e14e11402a" : return "intacto"  //localhost:4201
      case "5cca438980ad2bbd08527c7b444e3c05" : return "bano" //localhost: 4202
      default: return ""
    }
  }
  ...
  getLanguage():string{
    ...
    let lang = typeof(params[3])==="string" ? params[3].toUpperCase() : '';
  ...
  getProvince(): string {
    ...
    let allowed = ['QC', 'ON'];
    let params: string[] = window.location.pathname.split("/");
    let prov = typeof (params[2]) === "string" ? params[2].toUpperCase() : '';
